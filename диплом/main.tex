...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{pol17.png}
    \caption{Подогнанная поляризация при пороге=17}
    \label{fig:placeholder}
\end{figure}
$k=0.91$
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{pol50.png}
    \caption{Подогнанная поляризация при пороге=50}
    \label{fig:placeholder}
\end{figure}
$k=0.84$
