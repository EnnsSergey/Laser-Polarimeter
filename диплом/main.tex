...
\begin{figure}[H]
    ...
    \label{fig:placeholder}
\end{figure}
Максимум находится при заряде в 17 электронов. Пунктирной линией обозначены значения устанавливаемых в следущих экспериментах порогах.
...
В этом разделе будет разработан метод вычисления разброса в пучке по экспериментальным данным.
\begin{figure}[H]
    \centering
...
$k=0.938 \pm 0.021$
\\
Остальные результаты вынесены в приложение.
...
\begin{figure}[H]
    ...
    \label{fig:placeholder}
\end{figure}
Мы видим, что подгонка поляризации имеет систематический сдвиг и он зависит от порога для заряда на паде.
\newpage
\section{Приложение}
\subsection{A}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{pol25.png}
    \caption{Подогнанная поляризация при пороге=25}
    \label{fig:placeholder}
\end{figure}
$k=0.912 \pm 0.025$
\begin{figure}[H]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{pol75.png}
    \caption{Подогнанная поляризация при пороге=75}
    \label{fig:placeholder}
\end{figure}
$k=0.791 \pm 0.035$
\begin{figure}[H]
